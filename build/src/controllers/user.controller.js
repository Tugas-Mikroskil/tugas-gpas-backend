...
var UserController = /** @class */ (function () {
    ...
    UserController.signup = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, role, userRepository, existingUser, encryptedPassword, user, token, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        error_1 = _b.sent();
                        return [2 /*return*/, res.status(500).json({ message: "An error occurred", error: error_1.message })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        res.status(200).json({ message: "udpdate", user: user });
                        return [2 /*return*/];
                }
            });
        });
